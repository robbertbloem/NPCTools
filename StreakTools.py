...
# def gaussian_single_exponential(t, A):
# 
#     """
...
# 
#     """
#     y = ( A[3] / (A[0] * numpy.sqrt(2*numpy.pi)) ) * numpy.exp( -(t - A[1])**2 / (2 * A[0]**2) ) * numpy.exp(-t / A[4]) + A[2]
# 
#     return y
    

# def gaussian_single_exponential(t, A0, A1, A2, A3, A4):
# 
#     """
#     A[0]: sigma (sigma^2 = variance)
#     A[1]: mu (mean)
...
# 
#     """
#     y = ( A3 / (A0 * numpy.sqrt(2*numpy.pi)) ) * numpy.exp( -(t - A1)**2 / (2 * A0**2) ) * numpy.exp(-t / A4) + A2
# 
#     return y    
# 
# 
...
#         _y = y
# 
#     A_start = numpy.array([A_laser[0], A_laser[1], A_laser[2], A_laser[3], y[-1]/4])
# 
#     A_out = scipy.optimize.curve_fit(gaussian_single_exponential, _y, data, p0 = A_start)[0]
#     print(len(A_out))
#     print(A_out)
#     out = gaussian_single_exponential(_y, A_out[0], A_out[1], A_out[2], A_out[3], A_out[4])
# 
#     plt.plot(_y, data)
#     plt.plot(_y, out)
...
#     """
#     
#     g = numpy.fft.fft(( t[4] / (t[1] * numpy.sqrt(2*numpy.pi)) ) * numpy.exp( -(t[0] - t[2])**2 / (2 * t[1]**2) ) )
#     e = numpy.fft.fft( numpy.exp(-t[0] / A))
#     
#     f = g * e
#     
#     y = numpy.real(numpy.fft.ifft(f)) + t[3]
# 
#     return y    
# 
# # 
# # def gaussian_bi_exponential(t, A):
# # 
# #     """
# #     A[0]: sigma (sigma^2 = variance)
# #     A[1]: mu (mean)
...
# #     A_out = scipy.optimize.curve_fit(gaussian_single_exponential, _y, data, p0 = A_start)[0]
#     
#     t = [_y, A_laser[0], A_laser[1], A_laser[2], A_laser[3]]
#     A = y[-1]/4
# #     1 = y[-1]/6
# #     A2 = y[-1]/6
...
#     print(len(A_out))
#     print(A_out)
#     out = gaussian_single_exponential(t, A_out)
# 
#     plt.plot(_y, data)
#     plt.plot(_y, out)
...
# def gaussian_single_exponential(A, t):
# 
#     """
#     A[0]: sigma (sigma^2 = variance)
#     A[1]: mu (mean)
...
#     """
#     
#     g = numpy.fft.fft(( A[1] / (t[1] * numpy.sqrt(2*numpy.pi)) ) * numpy.exp( -(t[0] - t[2])**2 / (2 * t[1]**2) ) )
#     e = numpy.fft.fft( numpy.exp(-t[0] / A[0]))
#     
#     f = g * e
#     
#     y = numpy.real(numpy.fft.ifft(f)) + A[2]
# 
#     return y    
...
#     print(len(A_out))
#     print(A_out)
#     out = gaussian_single_exponential(A_out, t)
# 
#     plt.plot(_y, data)
#     plt.plot(_y, out)
