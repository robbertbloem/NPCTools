...
def effect_gvd_for_pulselengths():
    ...
    wl_um = [0.8]
    t_fs = numpy.arange(10,100) # ndarray: [10, 11, 12, ..., 149]
    d_mm = [10]
    ...
    ax[ax_i].legend()
    ax[ax_i].plot([0,100], [0,100], color = "black", linewidth = 1)
    ax[ax_i].set_title("Effect on pulse length for 10 mm at 800 nm")
